...
class _LoginHistoryState extends State<LoginHistory> {
  ...
  Future<String> getLoginHistory() async {
    String link = "https://wapi.alphakoin.io/api/wallet/login_history";
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: new ListView.builder(
          itemCount: loginHistory == null ? 0 : loginHistory.length,
              ...
              child: Column(
                ...
                children: <Widget>[
                  new ListTile(
                    ...
                    title: Text(loginHistory[index]["ip"]),
                    subtitle: Text(loginHistory[index]["created_at"]),
                  ),
                ],
              ),
            );
